...
export abstract class EdgeRendererClass {
   ...
   */
  public abstract renderVirtualEdge(startNode: Node, mouseLocation: Vector): void;
   ...
   * @param endNode 
   */
  public abstract renderVirtualConfirmedEdge(startNode: Node, endNode: Node): void;
  /**
   * 获取这个线在切断时的特效
   ...
   * 获取这个线在连接成功时的特效
   */
  abstract getConnectedEffects(startNode: Node, toNode: Node): Effect[];
}

...
export default function Dialog() {
  ...
  return (
    <div
      className={cn(
        // z-[999]是PopupDialog
        "fixed z-[998] flex flex-col gap-4 overflow-auto text-wrap break-words p-8 text-white shadow-xl shadow-neutral-900 transition duration-500 ease-[cubic-bezier(.19,1,.22,1)]",
        {

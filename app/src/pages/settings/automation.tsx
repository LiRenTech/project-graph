...
export default function AutoNamer() {
  return (
    <>
      <SettingField icon={<Tag />} settingKey="autoNamerTemplate" type="text" placeholder="例如：p{{i}}" />
      <SettingField icon={<Tag />} settingKey="autoNamerSectionTemplate" type="text" placeholder="例如：section{{i}}" />
      <SettingField icon={<HardDriveDownload />} settingKey="autoSaveWhenClose" type="switch" />
